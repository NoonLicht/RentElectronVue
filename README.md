...
VALUES 
    (1, 'Комфортабельный коттедж в экологически чистом районе Москвы'),
    (2, 'Элитный дом в центре Москвы с роскошным интерьером и видом на парк'),
    (3, 'Уютная квартира с современным дизайном в Москве'),
    (4, 'Просторный дом с бассейном и садом в историческом районе Москвы'),
    (5, 'Стильный лофт в центре Москвы с панорамными окнами'),
    (6, 'Уединенный коттедж в лесном массиве Москвы для спокойного отдыха'),
    (7, 'Светлая квартира с панорамным видом на город в Москве'),
    (8, 'Домик на берегу реки Москвы с прекрасным видом на природу'),
    (9, 'Историческая усадьба с большим садом в центре Москвы'),
    (10, 'Комфортабельная квартира в центре Москвы с видом на город');
...
VALUES 
    (1, 'Коттедж в экологически чистом районе', 'Коттедж', 3, 2, 4, 500, 2),
    (2, 'Элитный дом в центре с видом на парк', 'Дом', 5, 3, 6, 800, 3),
    (3, 'Уютная квартира с современным дизайном', 'Квартира', 1, 1, 2, 100, 5),
    (4, 'Просторный дом в историческом районе с бассейном', 'Дом', 4, 3, 5, 700, 2),
    (5, 'Стильный лофт с панорамными окнами', 'Лофт', 1, 0, 1, 80, 6),
    (6, 'Уединенный коттедж в лесном массиве', 'Коттедж', 2, 1, 3, 300, 1),
    (7, 'Светлая квартира с панорамным видом на город', 'Квартира', 2, 1, 3, 120, 9),
    (8, 'Домик на берегу реки с прекрасным видом на природу', 'Дом', 3, 2, 4, 600, 1),
    (9, 'Историческая усадьба с большим садом', 'Усадьба', 6, 4, 8, 1000, 2),
    (10, 'Комфортабельная квартира в центре с видом на город', 'Квартира', 2, 2, 3, 150, 8);
